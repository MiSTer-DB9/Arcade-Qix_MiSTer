...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Qix_MiSTer.git"
CORE_NAME=(Qix)
...
UPSTREAM_CORE_NAME=(Qix)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Qix.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Qix.rbf)
